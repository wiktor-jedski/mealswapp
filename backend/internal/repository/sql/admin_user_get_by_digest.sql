-- Implements DESIGN-009 UserAdminPanel exact encrypted-email lookup.
SELECT account.id,
...
WHERE account.normalized_email_lookup_key_version = $1
  AND account.normalized_email_digest = $2;
