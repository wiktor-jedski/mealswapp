-- Implements DESIGN-009 ItemCurator durable manual global-item create response completion.
UPDATE mutation_idempotency_keys
SET status_code = 201, response_body = $4, updated_at = NOW()
WHERE user_id = $1 AND method = 'POST' AND route = '/admin/items' AND key = $2 AND body_hash = $3
