...
VALUES
    ...
    ('22000000-0000-0000-0000-000000000101', 'single', 'Chicken Breast', 'solid', 15, 150, 31, 0, 3.6),
    ('22000000-0000-0000-0000-000000000102', 'single', 'Turkey Breast', 'solid', 15, 150, 29, 0, 1),
    ('22000000-0000-0000-0000-000000000103', 'single', 'Lean Beef', 'solid', 15, 150, 26, 0, 10),
    ('22000000-0000-0000-0000-000000000104', 'single', 'Salmon Fillet', 'solid', 15, 150, 20, 0, 13),
    ('22000000-0000-0000-0000-000000000105', 'single', 'Tuna in Water', 'solid', 2, 120, 26, 0, 1),
    ('22000000-0000-0000-0000-000000000106', 'single', 'Egg Whites', 'solid', 5, 100, 11, 0.7, 0.2),
    ('22000000-0000-0000-0000-000000000107', 'single', 'Whole Eggs', 'solid', 5, 100, 13, 1.1, 11),
    ('22000000-0000-0000-0000-000000000108', 'single', 'Protein Isolate', 'solid', 1, 30, 90, 0, 0),
    ('22000000-0000-0000-0000-000000000109', 'single', 'Firm Tofu', 'solid', 10, 150, 17, 3, 9),
    ('22000000-0000-0000-0000-000000000110', 'single', 'Seitan', 'solid', 10, 150, 75, 12, 2),
    ('22000000-0000-0000-0000-000000000111', 'single', 'Cooked White Rice', 'solid', 20, 180, 2.7, 28, 0.3),
    ('22000000-0000-0000-0000-000000000112', 'single', 'Cooked Brown Rice', 'solid', 25, 180, 2.6, 23, 0.9),
    ('22000000-0000-0000-0000-000000000113', 'single', 'Rolled Oats', 'solid', 5, 80, 16.9, 66.3, 6.9),
    ('22000000-0000-0000-0000-000000000114', 'single', 'Boiled Potatoes', 'solid', 20, 200, 1.9, 20, 0.1),
    ('22000000-0000-0000-0000-000000000115', 'single', 'Sweet Potato', 'solid', 25, 200, 1.6, 20.1, 0.1),
    ('22000000-0000-0000-0000-000000000116', 'single', 'Whole Wheat Bread', 'solid', 1, 40, 13, 43, 4.2),
    ('22000000-0000-0000-0000-000000000117', 'single', 'Banana', 'solid', 1, 120, 1.1, 22.8, 0.3),
    ('22000000-0000-0000-0000-000000000118', 'single', 'Chickpeas', 'solid', 20, 160, 8.9, 27.4, 2.6),
    ('22000000-0000-0000-0000-000000000119', 'single', 'Lentils', 'solid', 20, 160, 9, 20, 0.4),
    ('22000000-0000-0000-0000-000000000120', 'single', 'Avocado', 'solid', 1, 150, 2, 8.5, 14.7),
    ('22000000-0000-0000-0000-000000000121', 'single', 'Peanut Butter', 'solid', 1, 30, 25, 20, 50),
    ('22000000-0000-0000-0000-000000000122', 'single', 'Almonds', 'solid', 1, 30, 21.2, 21.6, 49.9),
    ('22000000-0000-0000-0000-000000000123', 'single', 'Ghee', 'solid', 1, 15, 0, 0, 100),
    ('22000000-0000-0000-0000-000000000124', 'single', 'Cheddar Cheese', 'solid', 1, 40, 25, 1.3, 33),
    ('22000000-0000-0000-0000-000000000125', 'single', 'Granulated Sugar', 'solid', 1, 10, 0, 100, 0)
ON CONFLICT (id) DO UPDATE
